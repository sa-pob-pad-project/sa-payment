...
func main() {
	...
	paymentInformationRepository := repository.NewPaymentInformationRepository(gormDB)
	paymentAttemptRepository := repository.NewPaymentAttemptRepository(gormDB)
	...
	routes.SetupRoutes(app, paymentHandler, jwtService)
